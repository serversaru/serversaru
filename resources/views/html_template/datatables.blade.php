...
<div id="sortable-panel" class="">
	...
	<div id="titr-content" class="col-md-12">
		<h2>Data Tables</h2>
		<h5>Any data tables template with extentions...</h5>
	</div>
	...
	<div class="col-md-12 ">
		<div  class="panel panel-default">
			...
			<div class="panel-body">
				...
				<table id="example1" class="datatable1 table table-striped table-bordered width-100 cellspace-0" >
					<thead>
						<tr>
							<th>Name</th>
							<th>Position</th>
	...
	<div class="col-md-12 ">
		<div  class="panel panel-default">
			...
			<div class="panel-body">
				...
				<table id="example2" class="datatable1 table table-striped table-bordered width-100 cellspace-0">
					<thead>
						<tr>
							<th>Name</th>
							<th>Position</th>
	...
	<div class="col-md-12 ">
		<div  class="panel panel-default">
			...
			<div class="panel-body">
				...
				<table id="example3" class="datatable1 table table-striped table-bordered width-100 cellspace-0">
					<thead>
						<tr>
							<th>Name</th>
							<th>Position</th>
